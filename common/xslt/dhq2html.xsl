...
-->
  ...
  <xsl:template match="tei:publicationStmt">
    ...
    <xsl:function name="dhqf:recs">
        ...
        <xsl:variable name="inner_tabs" select="tokenize($identifiedRow, '\t')" />
    ...
    <xsl:template name="recommendations">
        ...
        <div id="recommendations">
          ...
          <!-- Tokenize rows and get the one matching this article's ID -->
          ...
          <xsl:sequence select="dhqf:make-recs-list($my_keyword_row, $keyword_rows)"/>
