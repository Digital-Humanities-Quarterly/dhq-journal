 ...
 equivalent) named staticSearch/ which points to staticSearch-1.4.5/,
 or rename staticSearch-1.4.5/ to staticSearch/.
 ...
 e.g., one might clone the repository, which has staticSearch-1.4.5/,
 and then install the current latest version as staticSearch-1.4.7/,
 and then install the development version as staticSearch_gitHub/;
 then select which one to use by establishing a symbolic link between
 staticSearch/ and the desired version-specific directory.
