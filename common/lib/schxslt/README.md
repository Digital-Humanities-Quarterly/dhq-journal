> [!NOTE]
> This software is in maintenance mode and receives bug fixes
only. See if you can update to
[SchXslt2](https://codeberg.org/schxslt/schxslt2).
...
[#135](https://codeberg.org/schxslt/schxslt/issues/135)) and phase variables (see
[#136](https://codeberg.org/schxslt/schxslt/issues/136)).
...
[#138](https://codeberg.org/schxslt/schxslt/issues/138)).
...
* Starting with version 1.5 every release on [this repository's release
  page](https://codeberg.org/schxslt/schxslt/releases) provides a ZIP file with just the XSLT stylesheets. This page also
...
* If you use [BaseX](https://basex.org) or [eXist](https://exist-db.org) you can download installable XQuery modulesq
  from [this repository's release page](https://codeberg.org/schxslt/schxslt/releases) as well.
...
```
dmaus@carbon ~ % git clone --recursive https://codeberg.org/schxslt/schxslt.git
...
[releases](https://codeberg.org/schxslt/schxslt/releases) page. To validate documents with your Schematron you first
...
Also take a look at [SchXslt Java](https://codeberg.org/schxslt/schxslt-java), a set of Java classes for Schematron
